...
unlocked to sign the Geocoin-Qt.app bundle.
...
allowing somebody to distribute a Geocoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the geocoin-qt.exe file inside the installer had not been tampered with.
